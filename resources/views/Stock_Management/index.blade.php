...
<body class="bg-white">
    ...
    <nav class="nav w-full">
        <div class=" bg-white flex flex-wrap items-center justify-between p-4">
            <a href="/index" class="flex items-center">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap text-green-600">Stock
                    Management</span>
            </a>

            <div class="w-full bg-white md:block md:w-auto border-r-2 border-green-500">
                <ul
    ...
    <div class="content flex">
        <div class="side bg-gray-100 px-2 w-1/6 ">

            <ul class="p-1 mt-12">
                <li><a href="/index" class="p-2 flex hover:text-green-700"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        Home</a></li>
                <li><a href="#" class="p-2 flex hover:text-green-700"><svg xmlns="http://www.w3.org/2000/svg"
                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                            class="w-6 h-6 mr-2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" />
        ...
        <div class="content w-5/6 overflow-y-auto">
            @yield('content')
        </div>
    </div>
</body>
