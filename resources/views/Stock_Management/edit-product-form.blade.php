        ...
        <form action="{{ url('products/' . $product->id . '/update') }}" id="products-form" method="post"
            ...
            <div class="mb-1">
                ...
                <input type="radio" name="status" id="status" value="In-Active"
                    {{ $product->status === 'In-Active' ? 'checked' : '' }} />
            ...
            <div class="mb-1 text-center">
                <button type="submit"
                    class="bg-green-600 hover:bg-green-400 text-white py-1 px-3 border-b-4 border-green-700 hover:border-green-500 rounded">Update</button>
                </a>
                <a href="/products"
